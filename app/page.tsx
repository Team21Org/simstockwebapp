...
export default function Index() {
  return (
    <>
      ...
      />
      <p id="hometxt">
        Sim Stock is your one-stop shop for all of your investment needs,
        offering an intuitive and ideal platform for managing your portfolio
        whenever needed and interacting with the market during active hours.
        With our solution, you will be able to track all of your transactions on
        the market, review your stock holdings, and deposit and cash out your
        balance all under one platform! Whether you are a new or experienced
        trader, Sim Stock holds all of the tools that will ensure your financial
...
<<<<<<< HEAD
      ...
      />
      <Link href="/signup">
        <h4 id="h4alt2"> Sign Up For Free!</h4>
      </Link>
      <Image
        id="homeimg3"
        src="/stockicon.png"
