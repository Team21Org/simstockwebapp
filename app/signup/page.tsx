    ...
    <>
      ...
      <form id="signupForm" action="/api/signup" method="POST">
        ...
        <div id="loginFormTitle"> Start Your SimStock Journey Today! </div>
          ...
          <input type="email" name="confirmEmail" id="confirmEmail" required placeholder="Confirm E-Mail Address" />
          ...
          <button type="submit" id="accbtn4" > SUBMIT </button>
          <Link id="accbtn2" href="/login"> Already Have An Account? Click Here! </Link>
        </div>
      </form>
